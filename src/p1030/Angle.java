...
public class Angle implements Comparable<Angle> {
	 ...
	 * 
	 * <pre>
	 * 123 34 42 -123* 34' 42" (where * stands for the degree symbol) +45* 12'
	 * 30" (where * stands for the degree symbol) 45 12 30 S 45 12 30 N
	 * </p>
	 *
	 * @param dmsString
	...
	public static Angle acos(double cosine) { // Tom: this method is not used,
	...
	public static Angle atan(double tan) { // Tom: this method is not used,
											// should we delete it? (13th Dec
											// 06)
	 ...
	 * <p/>
	 * <ul>
	 * <li>min - If value < min</li>
	 * <li>max - If value > max</li>
	 * <li>value - If min <= value <= max</li>
	 * </ul>
	 *
	 * @param value
	 *            The angle to clamp.
	 * @param min
	 *            The minimum angle to clamp to.
	 * @param max
	 *            The maximum angle to clamp to.
	 *
